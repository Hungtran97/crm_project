                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên Dự án" value="${projectName }"
                                            class="form-control form-control-line" name="project-name"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày bắt đầu</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="yyyy-MM-dd" value="${startDate}"
                                            class="form-control form-control-line" name="start-date"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Ngày kết thúc</label>
                                    <div class="col-md-12">
                                        <input type="date" placeholder="yyyy-MM-dd" value="${endDate }"
                                            class="form-control form-control-line" name="end-date"> </div>
                                </div>
