                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="project-id">
                                        	<option>--Select project-- </option> 
                                            <c:forEach var="project" items="${projectList}">
                                            <option ${project.id == task.project.id ? "selected" : ""} value="${project.id}">${project.name}</option>
                                        	</c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc" name="task-name" value="${taskName}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="user-id">
                                            <option>--Select user-- </option> 
                                            <c:forEach var="user" items="${userList}">
                                            <option ${user.id == task.user.id ? "selected" : ""} value="${user.id}">${user.firstName} ${user.lastName}</option>
                                        	</c:forEach>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <div class="col-md-12" >
                                        <input type="number" name="status-id" value="${statusId}"
                                            class="form-control form-control-line"> 
                                    </div>
                                </div>
