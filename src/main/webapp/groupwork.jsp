                            ...
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <c:forEach var="project" items="${projectList}">                                    
                                        <tr>
                                            <td>${projectList.indexOf(project)+ 1}</td>
                                            <td>${project.name}</td>
                                            ...
                                            <td>
                                                <a href="groupwork-add?id=${project.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="#" project-id= "${project.id}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
